# 🛰️ Satellite Image-Based Climate Monitoring System
...
![Hugging Face](https://img.shields.io/badge/🤗%20Transformers-FFD21E)
...
│   └── inspect_oscd.py       # OSCD dataset schema inspection utilities
├── outputs/                  # Saved models, reports, plots (generated by running the pipeline)
├── main.py                   # Full pipeline entry point
├── verify_setup.py           # Environment/dependency sanity check
...
Python · PyTorch · TorchVision · TensorFlow · Scikit-learn · Hugging Face Transformers & Datasets · LangChain (+ LangGraph) · Pandas · NumPy · Matplotlib · Pillow
